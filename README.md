...
![A photo of the UI](https://github.com/ddemosi/react-around-api-full/main/around-dashboard.png?raw=true)

It also features responsive design and a hamburger icon with a mobile navigation menu.

![](https://github.com/ddemosi/react-around-api-full/main/around-mobile.png?raw=true)

![](https://github.com/ddemosi/react-around-api-full/main/around-mobile-open.png?raw=true)
